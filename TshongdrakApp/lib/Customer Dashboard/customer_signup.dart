...
class CustomerSignup extends StatefulWidget {
  ...
  _CustomerSignupState createState() => _CustomerSignupState();
    final String cid;
  const CustomerSignup({Key key, this.cid}) : super(key : key);
}
...
class _CustomerSignupState extends State<CustomerSignup> {
  ...
  Widget build(BuildContext context) {
     return Scaffold(
      body:  FutureBuilder(
        future: DefaultAssetBundle.of(context).loadString("asserts/customer.json"),
        builder: (context, snapshot){
          var myDoc = json.decode(snapshot.data.toString());
          return new ListView.builder(
              itemBuilder: (BuildContext context, int index) {
                return (myDoc[index]['cid'] == widget.cid) ?
                                              ...
                                              try {
                                                ...
                                                if(signedInUser !=null)
                                                {
                                                  ...
                                                  Map <String, dynamic> data = {
                                                    ...
                                                    await Firestore.instance.collection("MainCustomer").document(signedInUser.uid).setData(data);
                                                }
                                              }
                                              catch(e)
                                                    {
